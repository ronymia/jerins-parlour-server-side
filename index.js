...
const { connectToDatabase } = require("./utils/dbConnect"); // database connection
const errorHandler = require('./middlewares/errorHandler'); // global error handler
const userRoutes = require("./routers/v1/user.route");
const serviceRoutes = require("./routers/v1/service.route");
...
connectToDatabase().catch((errors) => {
     console.dir(errors)
});
...
// if database error not encountered
